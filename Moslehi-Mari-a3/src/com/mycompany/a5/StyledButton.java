...
public class StyledButton extends Button {
    ...
    public StyledButton(String label) {
        ...
        defaultStyle.setBorder(Border.createLineBorder(3, ColorUtil.WHITE));  // Thicker white border
        ...
        pressedStyle.setBorder(Border.createLineBorder(3, ColorUtil.WHITE));  // Same border thickness
    }
